        ...
        <div class="card" id="applicationList">
            <div class="card-header  border-0">
                <div class="d-flex align-items-center">
                    <h5 class="card-title mb-0 flex-grow-1">Job Application</h5>
                            ...
                            <tbody class="list form-check-all">
                                <tr>
                                    ...
                                    <td class="company">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(URL::asset('assets/images/brands/slack.png')); ?>" alt="" class="avatar-xxs rounded-circle image_src object-cover">
                                            </div>
                                        ...
                                        <div class="position-relative d-inline-block">
                                            ...
                                            <div class="avatar-lg p-1">
                                                <div class="avatar-title bg-light rounded-circle">
                                                    <img src="<?php echo e(URL::asset('assets/images/users/multi-user.jpg')); ?>" id="companylogo-img" class="avatar-md h-auto rounded-circle object-cover" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script src="<?php echo e(URL::asset('assets/js/pages/job-application.init.js')); ?>"></script>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\velzon_laravel_v2.0\default\Admin\resources\views/apps-job-application.blade.php ENDPATH**/ ?>