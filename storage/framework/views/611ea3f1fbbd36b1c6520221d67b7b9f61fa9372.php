            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        case ('ru'): ?>
                        <img src="<?php echo e(URL::asset('/assets/images/flags/russia.svg')); ?>" class="rounded" alt="Header Language" height="20">
                        <?php break; ?>
                        <?php case ('it'): ?>
                        <img src="<?php echo e(URL::asset('/assets/images/flags/italy.svg')); ?>" class="rounded" alt="Header Language" height="20">
                        <?php break; ?>
                        <?php case ('sp'): ?>
                        <img src="<?php echo e(URL::asset('/assets/images/flags/spain.svg')); ?>" class="rounded" alt="Header Language" height="20">
                        <?php break; ?>
                        <?php case ('ch'): ?>
                        <img src="<?php echo e(URL::asset('/assets/images/flags/china.svg')); ?>" class="rounded" alt="Header Language" height="20">
                        <?php break; ?>
                        <?php case ('fr'): ?>
                        <img src="<?php echo e(URL::asset('/assets/images/flags/french.svg')); ?>" class="rounded" alt="Header Language" height="20">
                        <?php break; ?>
                        <?php case ('gr'): ?>
                        <img src="<?php echo e(URL::asset('/assets/images/flags/germany.svg')); ?>" class="rounded" alt="Header Language" height="20">
                        <?php break; ?>
                        <?php case ('ae'): ?>
                        <img src="<?php echo e(URL::asset('/assets/images/flags/ae.svg')); ?>" class="rounded" alt="Header Language" height="20">
                        <?php break; ?>
                        <?php default: ?>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="<?php echo e(url('index/gr')); ?>" class="dropdown-item notify-item language" data-lang="gr" title="German">
                            <img src="<?php echo e(URL::asset('assets/images/flags/germany.svg')); ?>" alt="user-image" class="me-2 rounded" height="20"> <span class="align-middle">Deutsche</span>
                        </a>
                        ...
                        <a href="<?php echo e(url('index/ae')); ?>" class="dropdown-item notify-item language" data-lang="ae" title="Arabic">
                            <img src="<?php echo e(URL::asset('assets/images/flags/ae.svg')); ?>" alt="user-image" class="me-2 rounded" height="18">
                        ...
                        <div data-simplebar style="max-height: 300px;">
                            <div class="p-2">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/products/img-1.png')); ?>" class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/products/img-2.png')); ?>" class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/products/img-3.png')); ?>" class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/products/img-6.png')); ?>" class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/products/img-5.png')); ?>" class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                        ...
                        <div class="tab-content position-relative" id="notificationItemsTabContent">
                            ...
                            <div class="tab-pane fade py-2 ps-2" id="messages-tab" role="tabpanel" aria-labelledby="messages-tab">
                                <div data-simplebar style="max-height: 300px;" class="pe-2">
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item">
                                        <div class="d-flex">
                                            <img src="<?php echo e(URL::asset('assets/images/users/avatar-6.jpg')); ?>" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                            <div class="flex-1">
                                                <a href="#!" class="stretched-link">
...
<?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\velzon_laravel_v2.0\default\Admin\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>