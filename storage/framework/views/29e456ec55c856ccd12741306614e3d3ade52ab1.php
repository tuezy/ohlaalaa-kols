                                                ...
                                                <div class="position-relative d-inline-block">
                                                    ...
                                                    <div class="avatar-lg p-1">
                                                        <div class="avatar-title bg-light rounded-circle">
                                                            <img src="<?php echo e(URL::asset('assets/images/users/multi-user.jpg')); ?>" alt="" id="companylogo-img" class="avatar-md rounded-circle object-cover">
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <div class="card" id="company-view-detail">
            <div class="card-body text-center">
                <div class="position-relative d-inline-block">
                    <div class="avatar-md">
                        <div class="avatar-title bg-light rounded-circle">
                            <img src="<?php echo e(URL::asset('assets/images/brands/mail_chimp.png')); ?>" alt="" class="avatar-sm rounded-circle object-cover">
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\velzon_laravel_v2.0\default\Admin\resources\views/apps-crm-companies.blade.php ENDPATH**/ ?>