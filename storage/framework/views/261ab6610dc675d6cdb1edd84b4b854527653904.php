...
<?php $__env->startSection('title'); ?> Job Lists <?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
<?php $__env->startComponent('components.breadcrumb'); ?>
<?php $__env->slot('li_1'); ?> Jobs <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> Job Lists <?php $__env->endSlot(); ?>
...
<div class="row">
    ...
    <div class="col-xxl-3">
        <div class="card job-list-view-card overflow-hidden" id="job-overview">
            <img src="<?php echo e(URL::asset('assets/images/small/img-10.jpg')); ?>" alt="" id="cover-img" class="img-fluid background object-cover">
            <div class="card-body">
                <div class="avatar-md mt-n5">
                    <div class="avatar-title bg-light rounded-circle">
                        <img src="<?php echo e(URL::asset('assets/images/companies/img-7.png')); ?>" alt="" class="avatar-xs view-companylogo">
                    </div>
                </div>
                <div class="mt-3">
                        ...
                        <div class="col-lg-12">
                            <div class="px-1 pt-1">
                                <div class="modal-team-cover position-relative mb-0 mt-n4 mx-n4 rounded-top overflow-hidden">
                                    <img src="<?php echo e(URL::asset('assets/images/small/img-9.jpg')); ?>" alt="" id="modal-cover-img" class="img-fluid">
                            ...
                            <div class="text-center mb-4 mt-n5 pt-2">
                                <div class="position-relative d-inline-block">
                                    ...
                                    <div class="avatar-lg p-1">
                                        <div class="avatar-title bg-light rounded-circle">
                                            <img src="<?php echo e(URL::asset('assets/images/users/multi-user.jpg')); ?>" id="companylogo-img" class="avatar-md rounded-circle object-cover" />
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\velzon_laravel_v2.0\default\Admin\resources\views/apps-job-lists.blade.php ENDPATH**/ ?>