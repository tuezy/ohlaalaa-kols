...
<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.collections'); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
<?php $__env->startComponent('components.breadcrumb'); ?>
<?php $__env->slot('li_1'); ?> NFT Marketplac <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?>Collections <?php $__env->endSlot(); ?>
    ...
    <div class="col-lg-3">
        <div class="card">
            <div class="card-body">
                ...
                <!--end row-->
                <a href="#!" class="float-end"> View All <i class="ri-arrow-right-line align-bottom"></i></a>
                <h5 class="mb-0 fs-16"><a href="#!">3d Style <span class="badge badge-soft-success">4781</span></a></h5>
            </div>
        </div>
    </div>
    <!--end col-->
    <div class="col-lg-3">
        <div class="card">
            <div class="card-body">
                ...
                <!--end row-->
                <a href="#!" class="float-end"> View All <i class="ri-arrow-right-line align-bottom"></i></a>
                <h5 class="mb-0 fs-16"><a href="#!">Collectibles <span class="badge badge-soft-success">3468</span></a></h5>
            </div>
        </div>
    </div>
    <!--end col-->
    <div class="col-lg-3">
        <div class="card">
            <div class="card-body">
                ...
                <!--end row-->
                <a href="#!" class="float-end"> View All <i class="ri-arrow-right-line align-bottom"></i></a>
                <h5 class="mb-0 fs-16"><a href="#!">Videos <span class="badge badge-soft-success">1674</span></a></h5>
            </div>
        </div>
    </div>
    <!--end col-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\velzon_laravel_v2.0\default\Admin\resources\views/apps-nft-collections.blade.php ENDPATH**/ ?>