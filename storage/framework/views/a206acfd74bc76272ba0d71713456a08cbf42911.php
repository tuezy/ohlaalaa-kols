                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 product-item games music 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="<?php echo e(URL::asset('assets/images/nft/img-05.jpg')); ?>" alt="" class="card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                                <div class="place-bid-btn">
                                    <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="card shadow-none">
                            <div class="card-body">
                                <img src="<?php echo e(URL::asset('assets/images/nft/wallet.png')); ?>" alt="" class="avatar-sm">
                    ...
                    <div class="col-lg-3">
                        <div class="card shadow-none">
                            <div class="card-body">
                                <img src="<?php echo e(URL::asset('assets/images/nft/money.png')); ?>" alt="" class="avatar-sm">
                    ...
                    <div class="col-lg-3">
                        <div class="card shadow-none">
                            <div class="card-body">
                                <img src="<?php echo e(URL::asset('assets/images/nft/add.png')); ?>" alt="" class="avatar-sm">
                    ...
                    <div class="col-lg-3">
                        <div class="card shadow-none">
                            <div class="card-body">
                                <img src="<?php echo e(URL::asset('assets/images/nft/sell.png')); ?>" alt="" class="avatar-sm">
                        ...
                        <div class="card explore-box card-animate border">
                            <div class="card-body">
                                ...
                                <div class="explore-place-bid-img overflow-hidden rounded">
                                    <img src="<?php echo e(URL::asset('assets/images/nft/img-05.jpg')); ?>" alt="" class="explore-img w-100">
                                    <div class="bg-overlay"></div>
                                    <div class="place-bid-btn">
                                        <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card explore-box card-animate border">
                            <div class="card-body">
                                ...
                                <div class="explore-place-bid-img overflow-hidden rounded">
                                    <img src="<?php echo e(URL::asset('assets/images/nft/img-03.jpg')); ?>" alt="" class="explore-img w-100">
                                    <div class="bg-overlay"></div>
                                    <div class="place-bid-btn">
                                        <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                    </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\velzon_laravel_v2.0\default\Admin\resources\views/nft-landing.blade.php ENDPATH**/ ?>