...
<?php $__env->startSection('title'); ?> Companies List <?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
<?php $__env->startComponent('components.breadcrumb'); ?>
<?php $__env->slot('li_1'); ?> Companies <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> Companies List <?php $__env->endSlot(); ?>
            ...
            <div class="card-body">
                <div class="avatar-lg mx-auto mb-3">
                    <div class="avatar-title bg-light rounded">
                        <img src="<?php echo e(URL::asset('assets/images/companies/img-6.png')); ?>" alt="" class="avatar-sm company-logo">
                    </div>
                </div>
...
<script src="<?php echo e(URL::asset('assets/js/pages/job-companies-lists.init.js')); ?>"></script>

<!-- App js -->
<script src="<?php echo e(URL::asset('assets/js/app.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\velzon_laravel_v2.0\default\Admin\resources\views/apps-job-companies-lists.blade.php ENDPATH**/ ?>