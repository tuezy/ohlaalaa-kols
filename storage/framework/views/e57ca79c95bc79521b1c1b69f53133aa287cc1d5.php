<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.scrollSpy'); ?> <?php $__env->stopSection(); ?>
                        ...
                        <div class="live-preview">
                            <nav id="navbar-example" class="navbar navbar-dark bg-light px-3">
                                <a class="navbar-brand" href="#">
                                    <img src="<?php echo e(URL::asset('assets/images/logo-dark.png')); ?>" class="card-logo card-logo-dark" alt="logo dark" height="14">
                                    <img src="<?php echo e(URL::asset('assets/images/logo-light.png')); ?>" class="card-logo card-logo-light" alt="logo light" height="14">
                                </a>
                            ...
                            <div class="col-xxl-3">
                                <nav id="navbar-examplenested" class="navbar navbar-dark bg-light flex-column">
                                    <a class="navbar-brand mb-2" href="#">
                                        <img src="<?php echo e(URL::asset('assets/images/logo-dark.png')); ?>" class="card-logo card-logo-dark" alt="logo dark" height="15">
                                        <img src="<?php echo e(URL::asset('assets/images/logo-light.png')); ?>" class="card-logo card-logo-light" alt="logo light" height="15">
                                    </a>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\velzon_laravel_v2.0\default\Admin\resources\views/advance-ui-scrollspy.blade.php ENDPATH**/ ?>