...
<div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" alt="" class="avatar-md rounded-circle object-cover mt-n5 img-thumbnail border-light border-5 border-white mx-auto d-block">
                <a href="pages-profile">
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                <img src="<?php echo e(URL::asset('assets/images/users/avatar-6.jpg')); ?>" alt="" class="avatar-md rounded-circle object-cover mt-n5 img-thumbnail border-light border-5 border-white mx-auto d-block">
                <a href="pages-profile">
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                <img src="<?php echo e(URL::asset('assets/images/nft/img-06.jpg')); ?>" alt="" class="avatar-md rounded-circle object-cover mt-n5 img-thumbnail border-light border-5 border-white mx-auto d-block">
                <a href="pages-profile">
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                <img src="https://img.themesbrand.com/velzon/images/img-1.gif" alt="" class="avatar-md rounded-circle object-cover mt-n5 img-thumbnail border-light border-5 border-white mx-auto d-block">
                <a href="pages-profile">
    ...
    <div class="col">
        <div class="card">
            <img src="https://img.themesbrand.com/velzon/images/img-3.gif" alt="" class="object-cover card-img-top" height="120">
            <div class="card-body text-center">
                <img src="<?php echo e(URL::asset('assets/images/users/avatar-8.jpg')); ?>" alt="" class="avatar-md rounded-circle object-cover mt-n5 img-thumbnail border-light border-5 border-white mx-auto d-block">
                <a href="pages-profile">
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                <img src="<?php echo e(URL::asset('assets/images/users/avatar-10.jpg')); ?>" alt="" class="avatar-md rounded-circle object-cover mt-n5 img-thumbnail border-light border-5 border-white mx-auto d-block">
                <a href="pages-profile">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\default\resources\views/apps-nft-creators.blade.php ENDPATH**/ ?>