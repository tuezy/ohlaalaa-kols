    ...
    <div class="col-xl-3 col-md-6">
        <div class="card card-height-100 bg-soft-primary shadow-none bg-opacity-10">
            <div class="card-body">
                ...
                <div class="mb-4 pb-2">
                    <img src="{{URL::asset('assets/images/companies/img-6.png')}}" alt="" class="avatar-sm">
                </div>
                <a href="#!">
                    <h6 class="fs-15 fw-semibold">Sr. Web Designer <span class="text-muted fs-13">(2+ Yrs Exp.)</span></h6>
                </a>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card card-height-100 bg-soft-info shadow-none bg-opacity-10">
            <div class="card-body">
                ...
                <div class="mb-4 pb-2">
                    <img src="{{URL::asset('assets/images/companies/img-8.png')}}" alt="" class="avatar-sm">
                </div>
                <a href="#!">
                    <h6 class="fs-15 fw-semibold">Sr. Web Designer <span class="text-muted fs-13">(2+ Yrs Exp.)</span></h6>
                </a>
        ...
        <div class="card bg-primary">
            <div class="card-body p-0">
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-sm-4">
                        <div class="px-3">
                            <img src="{{URL::asset('assets/images/user-illustarator-1.png')}}" class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
            </div> <!-- end card-body-->
                        ...
                        <div class="swiper-slide" style="max-width: 200px;">
                            <div>
                                <div class="bg-soft-info rounded">
                                    <img src="{{URL::asset('assets/images/products/img-3.png')}}" alt="" style="max-height: 210px;max-width: auto;" />
                                </div>
                                <div class="pt-3">
                        ...
                        <div class="swiper-slide" style="max-width: 200px;">
                            <div>
                                <div class="bg-soft-success rounded">
                                    <img src="{{URL::asset('assets/images/products/img-4.png')}}" alt="" style="max-height: 210px;max-width: auto;" />
                                </div>
                                <div class="pt-3">
                                    <h5 class="text-secondary">$99.94</h5>
                                    <a href="#!">
                        ...
                        <div class="swiper-slide" style="max-width: 200px;">
                            <div>
                                <div class="bg-soft-warning rounded">
                                    <img src="{{URL::asset('assets/images/products/img-5.png')}}" alt="" style="max-height: 210px;max-width: auto;" />
                                </div>
                                <div class="pt-3">
                                    <h5 class="text-secondary">$99.94</h5>
                                    <a href="#!">
                        ...
                        <div class="swiper-slide" style="max-width: 200px;">
                            <div>
                                <div class="bg-soft-secondary rounded">
                                    <img src="{{URL::asset('assets/images/products/img-6.png')}}" alt="" style="max-height: 210px;max-width: auto;" />
                                </div>
                                <div class="pt-3">
                                    <h5 class="text-secondary">$99.94</h5>
                                    <a href="#!">
                ...
                <div class="d-flex align-items-center mb-3">
                    <div class="avatar-sm me-3 flex-shrink-0">
                        <div class="avatar-title bg-soft-info rounded">
                            <img src="{{URL::asset('assets/images/products/img-6.png')}}" alt="" class="avatar-xs">
                        </div>
                    </div>
                    <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center mb-3">
                    <div class="avatar-sm me-3 flex-shrink-0">
                        <div class="avatar-title bg-soft-danger rounded">
                            <img src="{{URL::asset('assets/images/products/img-8.png')}}" alt="" class="avatar-xs">
                        </div>
                    </div>
                    <div class="flex-grow-1">
                        <p class="text-muted mb-2">Adidas</p>
                            ...
                            <ul class="list-unstyled mb-0 pt-2" id="candidate-list">
                                <li>
                                    <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                                        <div class="flex-shrink-0 me-2">
                                            <div class="avatar-xs">
                                                <img src="{{URL::asset('assets/images/users/avatar-1.jpg')}}" alt="" class="img-fluid rounded-circle candidate-img">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <li>
                                    <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                                        <div class="flex-shrink-0 me-2">
                                            <div class="avatar-xs">
                                                <img src="{{URL::asset('assets/images/users/avatar-2.jpg')}}" alt="" class="img-fluid rounded-circle candidate-img">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <li>
                                    <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                                        <div class="flex-shrink-0 me-2">
                                            <div class="avatar-xs">
                                                <img src="{{URL::asset('assets/images/users/avatar-3.jpg')}}" alt="" class="img-fluid rounded-circle candidate-img">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <li>
                                    <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                                        <div class="flex-shrink-0 me-2">
                                            <div class="avatar-xs">
                                                <img src="{{URL::asset('assets/images/users/avatar-4.jpg')}}" alt="" class="img-fluid rounded-circle candidate-img">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <li>
                                    <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                                        <div class="flex-shrink-0 me-2">
                                            <div class="avatar-xs">
                                                <img src="{{URL::asset('assets/images/users/avatar-5.jpg')}}" alt="" class="img-fluid rounded-circle candidate-img">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                ...
                <div class="col-lg-6">
                    <div class="card-body text-center">
                        <div class="avatar-md mb-3 mx-auto">
                            <img src="{{URL::asset('assets/images/users/avatar-1.jpg')}}" alt="" id="candidate-img" class="img-thumbnail rounded-circle shadow-none">
                        </div>
...
<script src="{{URL::asset('assets/libs/card/card.min.js')}}"></script>
